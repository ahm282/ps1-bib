"""
This script collects book information from Standaard Boekhandel and cover images from Google Books API.
The information collected includes: book titles (Standaard Boekhandel), author names (Standaard Boekhandel),
...
Attributes:
    ...
    URL (str): A constant string representing the Standaard Boekhandel URL.
...
Exceptions:
    requests.exceptions.Timeout: Raised when a request to Standaard Boekhandel or Google Books API times out.
    requests.exceptions.ConnectionError: Raised when a connection error occurs when
                                        making a request to Standaard Boekhandel or Google Books API.
